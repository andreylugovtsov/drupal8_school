...
/**
 * Class CurrencyDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from CurrencyFormBase. The reason for
...
class CurrencyDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete currency %label?', array(
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Currency %label was deleted.', array(
      '%label' => $this->entity->label(),
    )));
